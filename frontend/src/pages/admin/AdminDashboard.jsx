            ...
            <>
              <div className="dash-stats-grid">
                <div className="dash-stat-card">
                  ...
                  <div className="dash-stat-value">{summary?.totalEmployees || 0}</div>
                </div>

                <div className="dash-stat-card">
                  <div className="dash-stat-header">
                    <Shield size={16} style={{ color: '#8b5cf6' }} />
                    <span className="dash-stat-label">Total Managers</span>
                  </div>
                  <div className="dash-stat-value">{summary?.totalManagers || 0}</div>
                </div>
              ...
              <div className="dashboard-grid">
                <div className="dash-card">
                  <div className="dash-card-header">
                    ...
                    <p className="dash-card-title">Organization Attendance</p>
                  </div>
                  <div className="attendance-row">
                    <span className="attendance-label">Total Staff</span>
                    <span className="attendance-value">{(summary?.totalEmployees || 0) + (summary?.totalManagers || 0)}</span>
                  </div>
                  <div className="attendance-row">
                ...
                <div className="dash-card">
                  <div className="dash-card-header">
                    ...
                    <p className="dash-card-title">Organization Activity</p>
                  </div>
                  <div className="attendance-row">
